    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                Toast.makeText(SampleActivity.this, "Data refreshed!", Toast.LENGTH_SHORT).show();
            }
        });

        SharedPreferences mPreferences = PreferenceManager.getDefaultSharedPreferences(SampleActivity.this);
        ...
        nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                {
                    case R.id.news:
                        startActivity(new Intent(SampleActivity.this,NewsActivity.class));
                        Toast.makeText(SampleActivity.this, "My Account",Toast.LENGTH_SHORT).show();break;
                    case R.id.safety:
                        startActivity(new Intent(SampleActivity.this,SafetyActivity.class));
                        Toast.makeText(SampleActivity.this, "Safety Measures",Toast.LENGTH_SHORT).show();break;
                    case R.id.settings:
                        startActivity(new Intent(SampleActivity.this,SampleActivity.class));
                        Toast.makeText(SampleActivity.this, "Settings",Toast.LENGTH_SHORT).show();break;
                    case R.id.logout:
                        FirebaseAuth.getInstance().signOut();
                        startActivity(new Intent(SampleActivity.this,LoginActivity.class));
                        finish();
                        Toast.makeText(SampleActivity.this, "Logout",Toast.LENGTH_SHORT).show();break;
                    default:
                        return true;
                }
                return true;
    ...
    public void showProgressDialog() {
        ...
        Runnable progressRunnable = new Runnable() {
            ...
            public void run() {
                if (confirmation != 1) {
                    progressDialog.cancel();
                    Toast.makeText(SampleActivity.this, "Internet slow/not available", Toast.LENGTH_SHORT).show();
                }
            }
        };
        Handler pdCanceller = new Handler();
